...
const GALLERY_ITEMS = [
  ...
  { src: "/images/gallery-3.jpg", label: "Sweet 16" },
  { src: "/images/gallery-4.jpg", label: "Vineyard Reception" },
  { src: "/images/gallery-5.jpg", label: "Holiday Office Party" },
  { src: "/images/gallery-6.jpg", label: "Backyard Anniversary" },
];
        ...
        <div className="mt-14 grid grid-cols-2 gap-4 sm:grid-cols-3">
          {GALLERY_ITEMS.map((item, i) => (
            <motion.div
              ...
              className="group relative aspect-square overflow-hidden rounded-2xl border border-cream/10 bg-surface transition-transform duration-500 hover:scale-[1.03]"
            >
              <Image
                src={item.src}
                alt={item.label}
