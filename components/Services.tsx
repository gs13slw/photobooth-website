            ...
            {filtered.map((service) => {
              ...
              return (
                <motion.div
                  ...
                  className="group relative overflow-hidden rounded-3xl border border-cream/10 bg-surface p-7 transition-all duration-300 hover:-translate-y-1.5 hover:border-flash/30 hover:shadow-glow"
                >
                  <div
                    aria-hidden="true"
